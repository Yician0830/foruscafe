const ITEMS = [
  ...
  { key: 'lottery-c', label: 'C賞Q版愛心迷你扇(兩款隨機)',           type: 'stock' },
  { key: 'lottery-d', label: 'D賞迷你手幅吊飾',           type: 'stock' },
  { key: 'lottery-e', label: 'E賞Q版造型磁鐵(兩款隨機)',           type: 'stock' },
  { key: 'lottery-f', label: 'F賞Q版造型吊飾(10款隨機)',           type: 'stock' },
  { key: 'lottery-g', label: 'G賞Q版漢堡大頭扇',           type: 'stock' },
